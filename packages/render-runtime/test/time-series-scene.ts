export const timeSeriesScene = {
	...
	version: 1,
	runtime: {
		engine: 'klinecharts', engineVersion: '10.0.0', runtimeVersion: '0.1.0',
	},
	...
	data: [
		...
		{ timestamp: 1_767_312_000_000, values: { 'series-a': 15.67 } },
	],
	chart: {
	...
	viewport: {
		barSpace: 8, rightOffsetDistance: 24, anchorTimestamp: 1_767_312_000_000,
	},
	render: {
